        ...
        <nav className="flex flex-row-reverse justify-between px-4 lg:px-16 lg:py-2 ">
            ...
            <ul className="hidden py-2 lg:flex lg:flex-row lg:gap-4  lg:items-center ">
                {sections.map((section,index)=>{
                   return  <li key={index} className=""><a href="#" className='lg:hover:text-accent lg:active:text-white lg:active:bg-accent lg:active:rounded lg:active:px-1 py-2'>{section}</a></li>
                 })
                }
            </ul>
